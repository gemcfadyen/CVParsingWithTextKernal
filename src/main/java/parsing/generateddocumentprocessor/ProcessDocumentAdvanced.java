...
/**
 * <p>Java class for processDocumentAdvanced complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="processDocumentAdvanced">
 *   &lt;complexContent>
 ...
 *         &lt;element name="clientSpecificArguments" type="{http://home.textkernel.nl/sourcebox/soap/documentProcessor}entry" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "processDocumentAdvanced", propOrder = {
    "account",
    "username",
    "password",
...
public class ProcessDocumentAdvanced {

    protected String account;
    protected String username;
    protected String password;
    @XmlElement(nillable = true)
    protected List<Entry> clientSpecificArguments;
    ...
    /**
     * Gets the value of the clientSpecificArguments property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the clientSpecificArguments property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getClientSpecificArguments().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Entry> getClientSpecificArguments() {
        if (clientSpecificArguments == null) {
            clientSpecificArguments = new ArrayList<Entry>();
        }
        return this.clientSpecificArguments;
    }
